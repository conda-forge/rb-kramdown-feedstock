...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-kramdown-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7592&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-kramdown-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-kramdown` can be installed with:

```
conda install rb-kramdown
```

It is possible to list all of the versions of `rb-kramdown` available on your platform with:
